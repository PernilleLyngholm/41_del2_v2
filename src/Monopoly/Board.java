...
public class Board {
    Squares[] squares = new Squares[11]; {
        ...
        squares[1] = new Squares("Oh no! You have stepped in a Crater and broke your leg. Pay 100$ for your medical bill", -100, false);
        squares[2] = new Squares("You have entered the Palace gates and are rewarded with 100$", +100, false);
        squares[3] = new Squares("BRRR it's cold in the desert, buy a pair of gloves for 20$", -20, false);
        squares[4] = new Squares("Welcome to Walled City, you are rewarded with 180$", +180, false);
        squares[5] = new Squares("Stay safe in the Monastery", 0, true);
        ...
        squares[10] = new Squares("You have found gold in the mountains and sell it for 650$", +650, false);
    }
    ...
    public String getText (int sumFacevalue) {
        if (sumFacevalue == 12) {
